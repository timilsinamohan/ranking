...
def innerfold(IDX,m,n):
    ...
    print "number of nonzeros before masking",np.count_nonzero(side_effects_drug_relation_copy)
    ...
    ###Before starrting diffusion lets use only 20% of the labelled nodes for the query###
